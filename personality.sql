...
--
-- Хост: localhost
-- Время создания: Дек 19 2012 г., 11:45
...
--
-- Структура таблицы `pb90c_assets`
--

CREATE TABLE IF NOT EXISTS `pb90c_assets` (
...
--
-- Дамп данных таблицы `pb90c_assets`
--

INSERT INTO `pb90c_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(32, 24, 60, 61, 1, 'com_users.category.7', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(35, 8, 20, 25, 2, 'com_content.category.8', 'news', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(36, 35, 21, 22, 3, 'com_content.article.1', 'Test_new', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(37, 35, 23, 24, 3, 'com_content.article.2', 'jkjlnkjnlk', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_associations`
--

CREATE TABLE IF NOT EXISTS `pb90c_associations` (
...
--
-- Структура таблицы `pb90c_banners`
--

CREATE TABLE IF NOT EXISTS `pb90c_banners` (
...
--
-- Структура таблицы `pb90c_banner_clients`
--

CREATE TABLE IF NOT EXISTS `pb90c_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pb90c_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `pb90c_banner_tracks` (
...
--
-- Структура таблицы `pb90c_categories`
--

CREATE TABLE IF NOT EXISTS `pb90c_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_categories`
--

INSERT INTO `pb90c_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(8, 35, 1, 13, 14, 1, 'news', 'com_content', 'news', 'news', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 956, '2012-12-16 21:01:24', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_contact_details`
--

CREATE TABLE IF NOT EXISTS `pb90c_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pb90c_content`
--

CREATE TABLE IF NOT EXISTS `pb90c_content` (
...
--
-- Дамп данных таблицы `pb90c_content`
--

INSERT INTO `pb90c_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 36, 'Test_new', 'test-new', '', '<p>{loadposition title_news_list}</p>\r\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.</p>', '', 1, 0, 0, 8, '2012-12-16 21:09:52', 956, '', '2012-12-19 08:53:05', 956, 0, '0000-00-00 00:00:00', '2012-12-16 21:09:52', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"images\\/img-2.jpg","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 13, 0, 1, '', '', 1, 58, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 37, 'jkjlnkjnlk', 'jkjlnkjnlk', '', '<p>klsdfjglkdfsj;glk;jdls;gkmlds;kmglds;kjgoeijgpoejgerkg.askjg;askjdf[gpja''sdk;ljvudspog;vjalkfg/.sdfkjviopem;rsgj/ldskfhg''eargj/skajm;iaserjg;/eakjgni;jsdlfgj;esr</p>', '', 1, 0, 0, 8, '2012-12-17 07:04:19', 956, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2012-12-17 07:04:19', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 8, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `pb90c_content_frontpage` (
...
--
-- Структура таблицы `pb90c_content_rating`
--

CREATE TABLE IF NOT EXISTS `pb90c_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pb90c_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `pb90c_core_log_searches` (
...
--
-- Структура таблицы `pb90c_extensions`
--

CREATE TABLE IF NOT EXISTS `pb90c_extensions` (
...
--
-- Дамп данных таблицы `pb90c_extensions`
--

INSERT INTO `pb90c_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10000, 'personality', 'template', 'personality', '', 0, 1, 1, 0, '{"legacy":false,"name":"personality","type":"template","creationDate":"10\\/10\\/09","author":"Ron Severdia","copyright":"Copyright (C) 2005 - 2012 Open Source Matters, Inc. All rights reserved.","authorEmail":"contact@kontentdesign.com","authorUrl":"http:\\/\\/www.kontentdesign.com","version":"2.5.0","description":"TPL_ATOMIC_XML_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'System - List of Articles', 'plugin', 'listofarticles', 'system', 0, 1, 1, 0, '{"legacy":false,"name":"System - List of Articles","type":"plugin","creationDate":"April 2011","author":"DesignCompass corp","copyright":"Copyright (C) 2010-2011 DesignCompassCorp. All rights reserved.","authorEmail":"admin@designcompasscorp.com","authorUrl":"http:\\/\\/www.designcompasscorp.com\\/","version":"1.1.6","description":"List of Articles Plugin v 1.1.6","group":""}', '{"articlecssclass":"","menucssclass":""}', '', '', 956, '2012-12-19 09:10:01', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_finder_filters`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_filters` (
...
--
-- Структура таблицы `pb90c_finder_links`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links` (
...
--
-- Структура таблицы `pb90c_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms0` (
...
--
-- Структура таблицы `pb90c_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `pb90c_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `pb90c_finder_taxonomy`
--

INSERT INTO `pb90c_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `pb90c_finder_terms`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_terms` (
...
--
-- Структура таблицы `pb90c_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `pb90c_finder_terms_common`
--

INSERT INTO `pb90c_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `pb90c_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pb90c_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `pb90c_finder_types`
--

CREATE TABLE IF NOT EXISTS `pb90c_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pb90c_languages`
--

CREATE TABLE IF NOT EXISTS `pb90c_languages` (
...
--
-- Дамп данных таблицы `pb90c_languages`
--

INSERT INTO `pb90c_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_menu`
--

CREATE TABLE IF NOT EXISTS `pb90c_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_menu`
--

INSERT INTO `pb90c_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'test-menu', 'test_article', 'test-article', '', 'test-article', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 43, 44, 0, '*', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_menu_types`
--

CREATE TABLE IF NOT EXISTS `pb90c_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_menu_types`
--

INSERT INTO `pb90c_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
(2, 'test-menu', 'test_menu', '');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_messages`
--

CREATE TABLE IF NOT EXISTS `pb90c_messages` (
...
--
-- Структура таблицы `pb90c_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `pb90c_messages_cfg` (
...
--
-- Структура таблицы `pb90c_modules`
--

CREATE TABLE IF NOT EXISTS `pb90c_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_modules`
--

INSERT INTO `pb90c_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"test-menu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(87, 'title_news_list', '', '<div class="list_of_titles">{articlesofcategory=8,1,0,0,title desc,hide,,,}</div>', 1, 'title_news_list', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_custom', 1, 0, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_modules_menu`
--

CREATE TABLE IF NOT EXISTS `pb90c_modules_menu` (
...
--
-- Дамп данных таблицы `pb90c_modules_menu`
--

INSERT INTO `pb90c_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `pb90c_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `pb90c_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `pb90c_overrider`
--

CREATE TABLE IF NOT EXISTS `pb90c_overrider` (
...
--
-- Структура таблицы `pb90c_redirect_links`
--

CREATE TABLE IF NOT EXISTS `pb90c_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_redirect_links`
--

INSERT INTO `pb90c_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://localhost/joomla2/index.php?option=com_content&task=view&id=1', '', '', '', 2, 0, '2012-12-17 06:43:38', '0000-00-00 00:00:00'),
(2, 'http://localhost/joomla2/index.php?option=com_content&task=view&id=1&Itemid=0', '', '', '', 1, 0, '2012-12-17 06:44:31', '0000-00-00 00:00:00'),
(3, 'http://localhost/joomla2/index.php?option=com_content&task=view&category=news&id=1', '', '', '', 2, 0, '2012-12-17 06:45:27', '0000-00-00 00:00:00'),
(4, 'http://localhost/joomla2/index.php?option=com_content&view=article&id=2', '', '', '', 1, 0, '2012-12-17 06:51:45', '0000-00-00 00:00:00'),
(5, 'http://localhost/joomla2/index.php?option=com_content&view=article&id=0', '', '', '', 1, 0, '2012-12-17 06:52:34', '0000-00-00 00:00:00'),
(6, 'http://localhost/joomla2/index.php?option=com_content&view=article&id=102', '', '', '', 2, 0, '2012-12-17 06:55:28', '0000-00-00 00:00:00'),
(7, 'http://localhost/joomla2/index.php?option=com_content&view=article&id=3', '', '', '', 1, 0, '2012-12-17 07:03:14', '0000-00-00 00:00:00'),
(8, 'http://localhost/joomla2/index.php?option=com_content&view=article&id=101', '', '', '', 1, 0, '2012-12-17 07:03:22', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_schemas`
--

CREATE TABLE IF NOT EXISTS `pb90c_schemas` (
...
--
-- Дамп данных таблицы `pb90c_schemas`
--

INSERT INTO `pb90c_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.8');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_session`
--

CREATE TABLE IF NOT EXISTS `pb90c_session` (
...
--
-- Дамп данных таблицы `pb90c_session`
--

INSERT INTO `pb90c_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('24255e383fda24101384b1868d30321a', 0, 1, '1355910086', '__default|a:7:{s:22:"session.client.browser";s:102:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.64 Safari/537.11";s:15:"session.counter";i:3;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:19:"session.timer.start";i:1355910005;s:18:"session.timer.last";i:1355910005;s:17:"session.timer.now";i:1355910086;}', 0, '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_template_styles`
--

CREATE TABLE IF NOT EXISTS `pb90c_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `pb90c_template_styles`
--

INSERT INTO `pb90c_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(6, 'beez5', 0, '0', 'Beez5 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/sampledata\\/fruitshop\\/fruits.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","html5":"0"}'),
(7, 'personality', 0, '1', 'personality - Default', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_updates`
--

CREATE TABLE IF NOT EXISTS `pb90c_updates` (
...
--
-- Дамп данных таблицы `pb90c_updates`
--

INSERT INTO `pb90c_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Структура таблицы `pb90c_update_categories`
--

CREATE TABLE IF NOT EXISTS `pb90c_update_categories` (
...
--
-- Структура таблицы `pb90c_update_sites`
--

CREATE TABLE IF NOT EXISTS `pb90c_update_sites` (
...
--
-- Дамп данных таблицы `pb90c_update_sites`
--

INSERT INTO `pb90c_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1355680329),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1355680329),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 0, 1355680329);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `pb90c_update_sites_extensions` (
...
--
-- Дамп данных таблицы `pb90c_update_sites_extensions`
--

INSERT INTO `pb90c_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Структура таблицы `pb90c_usergroups`
--

CREATE TABLE IF NOT EXISTS `pb90c_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `pb90c_usergroups`
--

INSERT INTO `pb90c_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Структура таблицы `pb90c_users`
--

CREATE TABLE IF NOT EXISTS `pb90c_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `pb90c_users`
--

INSERT INTO `pb90c_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(956, 'Super User', 'admin', 'tohakotliarenko@gmail.com', '58222d04b8dd91419791bb1b677f052a:CXGzmpBC4voN8cGBKvSijAl4hmLzMX0M', 'deprecated', 0, 1, '2012-12-12 12:26:46', '2012-12-19 08:20:02', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_user_notes`
--

CREATE TABLE IF NOT EXISTS `pb90c_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pb90c_user_profiles`
--

CREATE TABLE IF NOT EXISTS `pb90c_user_profiles` (
...
--
-- Структура таблицы `pb90c_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `pb90c_user_usergroup_map` (
...
--
-- Дамп данных таблицы `pb90c_user_usergroup_map`
--

INSERT INTO `pb90c_user_usergroup_map` (`user_id`, `group_id`) VALUES
(956, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `pb90c_viewlevels`
--

CREATE TABLE IF NOT EXISTS `pb90c_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `pb90c_viewlevels`
--

INSERT INTO `pb90c_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `pb90c_weblinks`
--

CREATE TABLE IF NOT EXISTS `pb90c_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
