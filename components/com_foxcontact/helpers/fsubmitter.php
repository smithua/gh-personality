	...
	*/
	...
	class FSubmitter extends FDataPump
	{
		...
		public function Show()
		{
			...
			$result .= '<div class="foxfield">' . PHP_EOL;
			...
			// Read more about "how to remove copyright attribution" at the following URL:
			// http://www.fox.ra.it/forum/14-licensing/151-remove-the-backlink-powered-by-fox-contact.html
			return $result . '</div><div class="fox-copyright" style="padding:10px 0 !important;text-indent:0 !important"><a target="_blank" title="Joomla contact form" href="http://www.fox.ra.it/" style="visibility: visible !important; display: inline !important; font-size:10px !important;">powered  by fox contact</a></div>';
		}
		...
		private function BuildCheckboxField($key, &$field)
		{
			...
			$result =
			'<div class="fox_copy_to_sender"><input ' .
			'type="checkbox" ' .
			'class="foxcheckbox" ' .
			"value=\"" . JText::_('JYES') . "\" " .
			$checked .
